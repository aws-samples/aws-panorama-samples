...
class BYTETracker(object):
    ...
    def update(self, frame_id, output_results):
        self.frame_id = frame_id
        activated_starcks = []
        refind_stracks = []
        lost_stracks = []
        ...
        score_categorysets = output_results[:, 4:]
        ...
        scores_keep = score_categorysets[remain_inds]
        scores_second = score_categorysets[inds_second]

...
output_saved_model_dir = "/panorama/saved_model_trt_fp16_tf27"
...
class ObjectDetectionApp(p.node):
    ...
    def __init__(self):
        ...
        app_function_dimension = {'Name': 'AppName', 'Value': 'TF27_TRT8'}
        ...
        self.metrics_handler = MetricsHandler("TF27_TRT8", metrics_factory)
    ...
    def run(self):
        ...
        while True:
            ...
            if len(input_images) >= self.model_batch_size:
                ...
                print("after inference", flush=True)

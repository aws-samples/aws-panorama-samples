# This file is based on the yolov5 repo https://github.com/ultralytics/yolov5 at commit "526e650"
import torch
import numpy as np
import cv2
import torchvision
...
class MockedFrame:
    ...
    def random_arr(self):
        if '720' in self.resolution:
            ...
            return cv2.imread('/panorama/yolov5/data/images/zidane.jpg')
        else:
...
# pre-process version 1
def preprocess_v1(self, img): 
...
def non_max_suppression(prediction,
    ...
    Args:
        prediction: [bs, num_boxes, cx ,cy, w, h,conf, num_class confidence]
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    """
    Plots one bounding box on image img, this function comes from YoLov5 project.

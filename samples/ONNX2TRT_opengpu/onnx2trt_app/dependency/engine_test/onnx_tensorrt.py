...
if __name__ == '__main__':
    ...
    parser.add_argument('-b','--batchsize', nargs='+', help='Setting the converted batch size', required=False, default=[1,4,8])
    parser.add_argument('-p','--fp', type=int, help='Floating Point Precision', required=False, default=16)
